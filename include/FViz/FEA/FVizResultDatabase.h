...
FVIZ_FEA_API FVizResult fviz_fea_history_series_create(
    const char* name,
...
FVIZ_FEA_API FVizResult fviz_fea_history_region_add_series(
    FVizFEAHistoryRegion* region, FVizFEAHistorySeries* series);
FVIZ_FEA_API FVizFEAHistorySeries* fviz_fea_history_region_series(
    FVizFEAHistoryRegion* region, const char* name);
FVIZ_FEA_API const FVizFEAHistorySeries* fviz_fea_history_region_const_series(
    const FVizFEAHistoryRegion* region, const char* name);
FVIZ_FEA_API FVizFEAHistorySeries* fviz_fea_history_region_series_at(
    FVizFEAHistoryRegion* region, FVizSize index);
FVIZ_FEA_API const FVizFEAHistorySeries* fviz_fea_history_region_const_series_at(
    const FVizFEAHistoryRegion* region, FVizSize index);
...
FVIZ_FEA_API FVizResult fviz_fea_step_create(
    const char* name,
    const char* description,
...
FVIZ_FEA_API FVizResult fviz_fea_step_find_frame_value(
...
FVIZ_FEA_API FVizResult fviz_fea_result_database_add_step(
...
FVIZ_FEA_API const FVizFEAStep* fviz_fea_result_database_const_step(const FVizFEAResultDatabase* database, const char* name);
FVIZ_FEA_API FVizFEAStep* fviz_fea_result_database_step_at(FVizFEAResultDatabase* database, FVizSize index);
FVIZ_FEA_API const FVizFEAStep* fviz_fea_result_database_const_step_at(const FVizFEAResultDatabase* database, FVizSize index);
