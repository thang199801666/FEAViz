...
FVIZ_FEA_API FVizResult fviz_fea_configure_abaqus_contour_lut(FVizLookupTable* table, uint32_t interval_count);
...
FVIZ_FEA_API FVizResult fviz_fea_build_abaqus_banded_surface(const FVizPolyData* input, const char* scalar_array_name,
                                                             uint32_t components, float range_minimum,
                                                             float range_maximum, uint32_t interval_count,
...
FVIZ_FEA_API FVizResult fviz_fea_extract_element_edges(const FVizPolyData* surface, FVizPolyData** out_edges);
 ...
 * map to grey. */
FVIZ_FEA_API FVizResult fviz_fea_build_contour_surface(const FVizPolyData* input, const char* scalar_array_name,
...
FVIZ_FEA_API FVizResult fviz_fea_build_contour_lines(const FVizPolyData* input, const char* scalar_array_name,
                                                     uint32_t components, float range_minimum, float range_maximum,
                                                     uint32_t interval_count, const char* output_scalar_array_name,
...
FVIZ_FEA_API FVizResult fviz_fea_find_extrema(const FVizPolyData* surface, const char* scalar_array_name,
                                              uint32_t components, FVizFEAExtrema* out_extrema);
...
FVIZ_FEA_API FVizResult fviz_fea_build_contour_surface_from_result(const FVizFEAPrimaryVariableResult* result,
                                                                   const FVizUnstructuredGrid* grid,
                                                                   FVizFEAContourMode mode, float range_minimum,
                                                                   float range_maximum, uint32_t interval_count,
                                                                   const char* output_color_array_name,
                                                                   FVizPolyData** out_surface);
...
FVIZ_FEA_API FVizResult fviz_fea_build_abaqus_banded_surface_ex(
    const FVizPolyData* input, const char* scalar_array_name, uint32_t components, float range_minimum,
    float range_maximum, uint32_t interval_count, const FVizFEABandedSurfaceOptions* options,
    const char* output_color_array_name, FVizPolyData** out_surface);
...
FVIZ_FEA_API FVizResult fviz_fea_slice_contour(const FVizUnstructuredGrid* grid, FVizPlane plane,
                                               const char* scalar_array_name, uint32_t components,
...
FVIZ_FEA_API FVizResult fviz_fea_build_element_facet_surface(const FVizUnstructuredGrid* grid,
