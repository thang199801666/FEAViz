...
FVIZ_API FVizResult fviz_volume_mapper_add_color_point(
...
FVIZ_API FVizResult fviz_volume_mapper_color_point_at(
    const FVizVolumeMapper* mapper, FVizSize index, FVizVolumeColorPoint* out_point);

FVIZ_API FVizResult fviz_volume_mapper_add_opacity_point(
...
FVIZ_API FVizResult fviz_volume_mapper_opacity_point_at(
...
FVIZ_API void fviz_volume_mapper_set_scalar_range(
    FVizVolumeMapper* mapper, float minimum, float maximum);
FVIZ_API void fviz_volume_mapper_get_scalar_range(
...
FVIZ_API void fviz_volume_mapper_set_options(
    FVizVolumeMapper* mapper, const FVizVolumeRenderOptions* options);
FVIZ_API void fviz_volume_mapper_options(
