...
FVIZ_API FVizResult fviz_glyph_mapper_set_source_poly_data(
...
FVIZ_API const FVizPolyData* fviz_glyph_mapper_const_source_poly_data(
    const FVizGlyphMapper* mapper);
FVIZ_API FVizResult fviz_glyph_mapper_reserve_instances(
    FVizGlyphMapper* mapper, FVizSize capacity);
FVIZ_API FVizResult fviz_glyph_mapper_add_instance(
    FVizGlyphMapper* mapper, const FVizGlyphInstance* instance);
FVIZ_API FVizResult fviz_glyph_mapper_add_instances(
    FVizGlyphMapper* mapper, const FVizGlyphInstance* instances, FVizSize count);
FVIZ_API FVizResult fviz_glyph_mapper_set_instance(
    FVizGlyphMapper* mapper, FVizSize index, const FVizGlyphInstance* instance);
FVIZ_API FVizResult fviz_glyph_mapper_set_instances(
...
FVIZ_API FVizResult fviz_glyph_mapper_get_instance(
...
FVIZ_API void fviz_glyph_mapper_set_gpu_residency_pinned(
    FVizGlyphMapper* mapper, FVizBool pinned);
FVIZ_API FVizBool fviz_glyph_mapper_gpu_residency_pinned(
    const FVizGlyphMapper* mapper);
/* Builds one glyph per non-zero point vector. vector_array_name==NULL uses active vectors. */
FVIZ_API FVizResult fviz_glyph_mapper_build_from_point_vectors(
    FVizGlyphMapper* mapper,
