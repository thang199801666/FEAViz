...
FVIZ_API FVizResult fviz_renderer_widget_create_with_options(
    int width,
    int height,
    const char* title,
...
FVIZ_API FVizResult fviz_renderer_widget_create(
    ...
    const char* title,
    FVizRendererWidget** out_widget);
FVIZ_API FVizResult fviz_renderer_widget_create_attached_with_options(
    void* host_native_handle,
    int width,
    int height,
    const FVizRenderWindowOptions* options,
    FVizRendererWidget** out_widget);
FVIZ_API FVizResult fviz_renderer_widget_create_attached(
    void* host_native_handle,
    int width,
    int height,
    FVizRendererWidget** out_widget);
FVIZ_API FVizResult fviz_renderer_widget_create_external_opengl_with_options(
    int width,
    int height,
    const FVizExternalOpenGLSurface* surface,
    const FVizRenderWindowOptions* options,
    FVizRendererWidget** out_widget);
FVIZ_API FVizResult fviz_renderer_widget_create_external_opengl(
    int width,
    int height,
    const FVizExternalOpenGLSurface* surface,
    FVizRendererWidget** out_widget);
...
FVIZ_API FVizResult fviz_renderer_widget_reparent(
    FVizRendererWidget* widget,
    void* host_native_handle);
