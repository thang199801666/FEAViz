...
FVIZ_RENDERING_API FVizResult fviz_render_pass_create(FVizRenderPassStage stage, FVizRenderPassExecuteFn execute, void* user_data,
                                            FVizRenderPassDestroyFn destroy_user_data, FVizRenderPass** out_pass);
FVIZ_RENDERING_API FVizRenderPassStage fviz_render_pass_stage(const FVizRenderPass* pass);
FVIZ_RENDERING_API FVizBool fviz_render_pass_is_custom(const FVizRenderPass* pass);
FVIZ_RENDERING_API FVizResult fviz_render_pass_execute(FVizRenderPass* pass, FVizRenderer* renderer,
