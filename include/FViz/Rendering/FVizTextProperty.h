...
FVIZ_API void fviz_text_property_get_color(const FVizTextProperty* property, float* red, float* green, float* blue, float* alpha);
FVIZ_API void fviz_text_property_set_background(FVizTextProperty* property, float red, float green, float blue, float alpha);
FVIZ_API void fviz_text_property_get_background(const FVizTextProperty* property, float* red, float* green, float* blue, float* alpha);
FVIZ_API void fviz_text_property_set_horizontal_alignment(FVizTextProperty* property, FVizTextHorizontalAlignment alignment);
FVIZ_API FVizTextHorizontalAlignment fviz_text_property_horizontal_alignment(const FVizTextProperty* property);
FVIZ_API void fviz_text_property_set_vertical_alignment(FVizTextProperty* property, FVizTextVerticalAlignment alignment);
...
FVIZ_API void fviz_text_property_set_shadow(FVizTextProperty* property, FVizBool enabled, float offset_x, float offset_y, float opacity);
FVIZ_API FVizBool fviz_text_property_shadow(const FVizTextProperty* property);
FVIZ_API void fviz_text_property_get_shadow(const FVizTextProperty* property, float* offset_x, float* offset_y, float* opacity);
