...
FVIZ_API FVizResult fviz_render_window_create_with_options(int width, int height, const char* title,
                                                           const FVizRenderWindowOptions* options,
                                                           FVizRenderWindow** out_window);
FVIZ_API FVizResult fviz_render_window_create_offscreen_with_options(int width, int height,
                                                                     const FVizRenderWindowOptions* options,
                                                                     FVizRenderWindow** out_window);
FVIZ_API FVizResult fviz_render_window_create(int width, int height, const char* title, FVizRenderWindow** out_window);
FVIZ_API FVizResult fviz_render_window_create_offscreen(int width, int height, FVizRenderWindow** out_window);
FVIZ_API FVizResult fviz_render_window_create_attached_with_options(void* host_native_handle, int width, int height,
                                                                    const FVizRenderWindowOptions* options,
                                                                    FVizRenderWindow** out_window);
FVIZ_API FVizResult fviz_render_window_create_attached(void* host_native_handle, int width, int height,
                                                       FVizRenderWindow** out_window);
FVIZ_API FVizResult fviz_render_window_create_external_opengl_with_options(int width, int height,
                                                                           const FVizExternalOpenGLSurface* surface,
                                                                           const FVizRenderWindowOptions* options,
                                                                           FVizRenderWindow** out_window);
FVIZ_API FVizResult fviz_render_window_create_external_opengl(int width, int height,
                                                              const FVizExternalOpenGLSurface* surface,
                                                              FVizRenderWindow** out_window);
...
FVIZ_API FVizResult fviz_render_window_reparent(FVizRenderWindow* window, void* host_native_handle);
FVIZ_API FVizResult fviz_render_window_read_rgba8(FVizRenderWindow* window, uint8_t* pixels, FVizSize capacity);
FVIZ_API FVizResult fviz_render_window_read_depth_f32(FVizRenderWindow* window, float* depth, FVizSize capacity);
FVIZ_API FVizResult fviz_render_window_write_ppm(FVizRenderWindow* window, const char* path);
FVIZ_API void fviz_render_window_get_capabilities(const FVizRenderWindow* window,
...
FVIZ_API FVizResult fviz_render_window_set_fxaa_options(FVizRenderWindow* window, const FVizFXAAOptions* options);
FVIZ_API void fviz_render_window_get_fxaa_options(const FVizRenderWindow* window, FVizFXAAOptions* out_options);
FVIZ_API void fviz_render_window_set_adaptive_antialiasing(FVizRenderWindow* window, FVizBool enabled);
...
FVIZ_API void fviz_render_window_get_statistics(const FVizRenderWindow* window, FVizRenderStatistics* out_statistics);
FVIZ_API FVizSize fviz_render_window_pass_statistics_count(const FVizRenderWindow* window);
FVIZ_API FVizResult fviz_render_window_get_pass_statistics(const FVizRenderWindow* window, FVizSize index,
                                                           FVizRenderPassStatistics* out_statistics);
FVIZ_API FVizResult fviz_render_window_hardware_pick(FVizRenderWindow* window, int x, int y,
                                                     FVizHardwarePick* out_pick);
FVIZ_API FVizResult fviz_render_window_hardware_pick_association(FVizRenderWindow* window, int x, int y,
                                                                 FVizSelectionAssociation association,
                                                                 FVizHardwarePick* out_pick);
...
FVIZ_API void fviz_render_window_request_render_reason(FVizRenderWindow* window, FVizRenderRequestReasons reasons);
...
FVIZ_API FVizRenderRequestReasons fviz_render_window_pending_render_reasons(const FVizRenderWindow* window);
FVIZ_API FVizFrameQuality fviz_render_window_frame_quality(const FVizRenderWindow* window);
FVIZ_API FVizResult fviz_render_window_set_frame_scheduler_options(FVizRenderWindow* window,
                                                                   const FVizFrameSchedulerOptions* options);
FVIZ_API void fviz_render_window_get_frame_scheduler_options(const FVizRenderWindow* window,
                                                             FVizFrameSchedulerOptions* out_options);
FVIZ_API void fviz_render_window_get_frame_scheduler_statistics(const FVizRenderWindow* window,
...
FVIZ_API FVizResult fviz_render_window_set_gpu_memory_options(FVizRenderWindow* window,
                                                              const FVizGPUMemoryOptions* options);
FVIZ_API void fviz_render_window_get_gpu_memory_options(const FVizRenderWindow* window,
...
FVIZ_API FVizResult fviz_render_window_release_gpu_mesh_resources(FVizRenderWindow* window);
...
FVIZ_API FVizResult fviz_render_window_pick(FVizRenderWindow* window, int x, int y, FVizRayHit* out_hit);
FVIZ_API FVizResult fviz_render_window_select_rectangle(FVizRenderWindow* window, int start_x, int start_y, int end_x,
                                                        int end_y, FVizSelection** out_selection);
FVIZ_API FVizResult fviz_render_window_select_rectangle_association(FVizRenderWindow* window, int start_x, int start_y,
                                                                    int end_x, int end_y,
                                                                    FVizSelectionAssociation association,
                                                                    FVizSelection** out_selection);
FVIZ_API FVizResult fviz_render_window_select_polygon(FVizRenderWindow* window, const int* xy_points,
                                                      FVizSize point_count, FVizSelectionAssociation association,
                                                      FVizSelection** out_selection);
FVIZ_API FVizResult fviz_render_window_select_at(FVizRenderWindow* window, int x, int y,
                                                 FVizSelectionAssociation association, FVizSelection** out_selection);
FVIZ_API void fviz_render_window_set_pick_callback(FVizRenderWindow* window, FVizPickCallbackFn callback,
                                                   void* user_data);
