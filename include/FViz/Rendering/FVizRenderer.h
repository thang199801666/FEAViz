...
FVIZ_API FVizResult fviz_renderer_get_frustum(const FVizRenderer* renderer, float aspect_ratio,
                                              FVizFrustum* out_frustum);
FVIZ_API FVizBool fviz_renderer_actor_in_frustum(const FVizRenderer* renderer, const FVizActor* actor,
                                                 float aspect_ratio);
...
FVIZ_API FVizResult fviz_renderer_set_small_object_threshold_pixels(FVizRenderer* renderer, float diameter_pixels);
FVIZ_API float fviz_renderer_small_object_threshold_pixels(const FVizRenderer* renderer);
FVIZ_API float fviz_renderer_actor_projected_diameter_pixels(const FVizRenderer* renderer, const FVizActor* actor,
                                                             float aspect_ratio, int viewport_height);
FVIZ_API FVizBool fviz_renderer_actor_is_renderable(const FVizRenderer* renderer, const FVizActor* actor,
                                                    float aspect_ratio, int viewport_height);
...
FVIZ_API FVizResult fviz_renderer_set_weighted_oit_options(FVizRenderer* renderer,
                                                           const FVizWeightedOITOptions* options);
FVIZ_API void fviz_renderer_get_weighted_oit_options(const FVizRenderer* renderer, FVizWeightedOITOptions* out_options);
...
FVIZ_API FVizResult fviz_renderer_set_viewport(FVizRenderer* renderer, float minimum_x, float minimum_y,
                                               float maximum_x, float maximum_y);
FVIZ_API void fviz_renderer_get_viewport(const FVizRenderer* renderer, float* minimum_x, float* minimum_y,
                                         float* maximum_x, float* maximum_y);
...
FVIZ_API FVizBool fviz_renderer_contains_normalized_point(const FVizRenderer* renderer, float x, float y);
...
FVIZ_API FVizResult fviz_renderer_remove_billboard_text_actor_3d(FVizRenderer* renderer,
...
FVIZ_API FVizResult fviz_renderer_world_to_view(const FVizRenderer* renderer, FVizVec3 world, FVizVec3* out_view);
FVIZ_API FVizResult fviz_renderer_view_to_ndc(const FVizRenderer* renderer, FVizVec3 view, float aspect_ratio,
                                              FVizVec3* out_ndc);
FVIZ_API FVizResult fviz_renderer_ndc_to_display(const FVizRenderer* renderer, FVizVec3 ndc, int window_width,
                                                 int window_height, FVizVec3* out_display);
FVIZ_API FVizResult fviz_renderer_world_to_display(const FVizRenderer* renderer, FVizVec3 world, int window_width,
                                                   int window_height, FVizVec3* out_display);
FVIZ_API FVizResult fviz_renderer_display_to_world_ray(const FVizRenderer* renderer, float display_x, float display_y,
