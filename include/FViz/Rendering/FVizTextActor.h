...
FVIZ_API const char* fviz_text_actor_2d_text(const FVizTextActor2D* actor);
FVIZ_API FVizResult fviz_text_actor_2d_set_text_property(FVizTextActor2D* actor, FVizTextProperty* property);
FVIZ_API FVizTextProperty* fviz_text_actor_2d_text_property(FVizTextActor2D* actor);
FVIZ_API const FVizTextProperty* fviz_text_actor_2d_const_text_property(const FVizTextActor2D* actor);
FVIZ_API void fviz_text_actor_2d_set_position(FVizTextActor2D* actor, float x, float y);
FVIZ_API void fviz_text_actor_2d_get_position(const FVizTextActor2D* actor, float* x, float* y);
FVIZ_API void fviz_text_actor_2d_set_coordinate_system(FVizTextActor2D* actor, FVizTextCoordinateSystem system);
FVIZ_API FVizTextCoordinateSystem fviz_text_actor_2d_coordinate_system(const FVizTextActor2D* actor);
FVIZ_API void fviz_text_actor_2d_set_visible(FVizTextActor2D* actor, FVizBool visible);
FVIZ_API FVizBool fviz_text_actor_2d_is_visible(const FVizTextActor2D* actor);
FVIZ_API FVizResult fviz_text_actor_2d_measure(const FVizTextActor2D* actor, FVizTextMetrics* out_metrics);
...
FVIZ_API void fviz_billboard_text_actor_3d_get_pixel_offset(const FVizBillboardTextActor3D* actor, float* x, float* y);
FVIZ_API void fviz_billboard_text_actor_3d_set_depth_test(FVizBillboardTextActor3D* actor, FVizBool enabled);
FVIZ_API FVizBool fviz_billboard_text_actor_3d_depth_test(const FVizBillboardTextActor3D* actor);
FVIZ_API void fviz_billboard_text_actor_3d_set_visible(FVizBillboardTextActor3D* actor, FVizBool visible);
FVIZ_API FVizBool fviz_billboard_text_actor_3d_is_visible(const FVizBillboardTextActor3D* actor);
