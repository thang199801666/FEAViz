...
FVIZ_API FVizResult fviz_font_atlas_create_system(const char* family, float pixel_size, FVizFontAtlas** out_atlas);
FVIZ_API FVizResult fviz_font_atlas_create_from_file(const char* file_path, const char* family, float pixel_size,
...
FVIZ_API FVizResult fviz_font_atlas_create_from_coverage(uint32_t width, uint32_t height,
