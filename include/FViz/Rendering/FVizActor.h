...
FVIZ_API void fviz_actor_set_pickable(FVizActor* actor, FVizBool pickable);
FVIZ_API FVizBool fviz_actor_pickable(const FVizActor* actor);
FVIZ_API FVizBounds fviz_actor_bounds(const FVizActor* actor);
...
FVIZ_API void fviz_actor_set_line_depth_bias(FVizActor* actor, float bias);
FVIZ_API float fviz_actor_line_depth_bias(const FVizActor* actor);
FVIZ_API void fviz_actor_set_line_cap(FVizActor* actor, FVizLineCap cap);
FVIZ_API FVizLineCap fviz_actor_line_cap(const FVizActor* actor);
FVIZ_API void fviz_actor_set_line_join(FVizActor* actor, FVizLineJoin join);
FVIZ_API FVizLineJoin fviz_actor_line_join(const FVizActor* actor);
...
FVIZ_API FVizBool fviz_actor_point_visibility(const FVizActor* actor);
FVIZ_API void fviz_actor_set_point_size(FVizActor* actor, float size_pixels);
FVIZ_API float fviz_actor_point_size(const FVizActor* actor);
...
FVIZ_API FVizCullMode fviz_actor_cull_mode(const FVizActor* actor);
