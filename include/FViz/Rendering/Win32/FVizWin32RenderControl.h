 ...
 * HWND exists. */
FVIZ_API FVizResult fviz_win32_render_control_create(
    void* parent_hwnd,
    int control_id,
    int x,
    int y,
...
FVIZ_API FVizResult fviz_win32_render_control_set_bounds(
    void* control_hwnd,
    int x,
    int y,
    int width,
...
FVIZ_API FVizResult fviz_win32_render_control_set_timer_pump(
    void* control_hwnd,
    FVizBool enabled,
