...
FVIZ_API FVizResult fviz_pvtu_reader_create_with_options(
    const FVizPVTUReaderOptions* options,
    FVizPVTUReader** out_reader);
FVIZ_API FVizResult fviz_pvtu_reader_set_file_name(
...
FVIZ_API const char* fviz_pvtu_reader_piece_source(
    const FVizPVTUReader* reader,
    FVizSize piece_index);
FVIZ_API uint32_t fviz_pvtu_reader_ghost_level(const FVizPVTUReader* reader);
FVIZ_API FVizResult fviz_pvtu_reader_load_piece(
    FVizPVTUReader* reader,
    FVizSize piece_index,
    FVizUnstructuredGrid** out_piece);
FVIZ_API FVizResult fviz_pvtu_reader_prefetch_piece(
    FVizPVTUReader* reader,
    FVizSize piece_index);
FVIZ_API FVizResult fviz_pvtu_reader_materialize(
    FVizPVTUReader* reader,
    FVizPartitionedDataSet** out_data_set);
FVIZ_API FVizResult fviz_pvtu_reader_set_cache_capacity(
    FVizPVTUReader* reader,
    FVizSize capacity);
...
FVIZ_API FVizResult fviz_pvtu_reader_set_cache_byte_capacity(
...
FVIZ_API FVizPVTUCacheStatistics fviz_pvtu_reader_cache_statistics(
    const FVizPVTUReader* reader);
...
FVIZ_API FVizResult fviz_pvtu_read(
    const char* file_path,
    FVizPartitionedDataSet** out_data_set);
FVIZ_API FVizResult fviz_pvtu_read_with_options(
    const char* file_path,
    const FVizPVTUReaderOptions* options,
    FVizPartitionedDataSet** out_data_set);
