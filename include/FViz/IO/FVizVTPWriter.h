...
FVIZ_IO_API void fviz_vtp_writer_options_initialize(FVizVTPWriterOptions* options);
FVIZ_IO_API FVizResult fviz_vtp_write(const char* file_path, const FVizPolyData* poly_data,
