...
FVIZ_DATA_API FVizResult fviz_cell_adjacency_build(const FVizCellArray* cells, FVizSize point_count,
                                              FVizCellAdjacency** out_adjacency);
FVIZ_DATA_API FVizSize fviz_cell_adjacency_cell_count(const FVizCellAdjacency* adjacency);
FVIZ_DATA_API FVizSize fviz_cell_adjacency_neighbor_count(const FVizCellAdjacency* adjacency, FVizId cell_id);
FVIZ_DATA_API const FVizId* fviz_cell_adjacency_neighbors(const FVizCellAdjacency* adjacency, FVizId cell_id,
                                                     FVizSize* out_count);
FVIZ_DATA_API FVizSize fviz_cell_adjacency_edge_count(const FVizCellAdjacency* adjacency);
