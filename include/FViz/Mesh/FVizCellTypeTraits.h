...
FVIZ_API FVizResult fviz_cell_type_edge(
    FVizCellType type,
    uint32_t edge_index,
    uint32_t out_local_point_ids[2]);
FVIZ_API FVizResult fviz_cell_type_face(
    FVizCellType type,
    uint32_t face_index,
...
FVIZ_API FVizResult fviz_cell_type_shape_weights(
    FVizCellType type,
    FVizVec3 parametric,
    double* out_weights,
    FVizSize capacity,
...
FVIZ_API FVizResult fviz_cell_type_linear_weights(
    FVizCellType type,
    FVizVec3 parametric,
    double* out_weights,
    FVizSize capacity,
