...
FVIZ_API FVizBool fviz_cell_type_is_supported(FVizCellType type);
FVIZ_API FVizCellTypeTraits fviz_cell_type_traits(FVizCellType type);
FVIZ_API FVizBool fviz_cell_type_accepts_point_count(FVizCellType type, FVizSize point_count);
FVIZ_API FVizResult fviz_cell_type_edge(FVizCellType type, uint32_t edge_index, uint32_t out_local_point_ids[2]);
FVIZ_API FVizResult fviz_cell_type_face(FVizCellType type, uint32_t face_index, uint32_t* out_local_point_ids,
...
FVIZ_API FVizResult fviz_cell_type_shape_weights(FVizCellType type, FVizVec3 parametric, double* out_weights,
...
FVIZ_API FVizResult fviz_cell_type_linear_weights(FVizCellType type, FVizVec3 parametric, double* out_weights,
                                                  FVizSize capacity, FVizSize* out_weight_count);
