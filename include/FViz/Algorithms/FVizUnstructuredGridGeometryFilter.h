...
FVIZ_API FVizResult fviz_unstructured_grid_geometry_filter_create(
    FVizUnstructuredGridGeometryFilter** out_filter);
FVIZ_API FVizResult fviz_unstructured_grid_geometry_filter_set_input_data(
    FVizUnstructuredGridGeometryFilter* filter,FVizUnstructuredGrid* input);
...
FVIZ_API FVizAlgorithm* fviz_unstructured_grid_geometry_filter_algorithm(
    FVizUnstructuredGridGeometryFilter* filter);
FVIZ_API FVizAlgorithmOutput* fviz_unstructured_grid_geometry_filter_output_port(
    FVizUnstructuredGridGeometryFilter* filter);
FVIZ_API FVizPolyData* fviz_unstructured_grid_geometry_filter_output(
    FVizUnstructuredGridGeometryFilter* filter);
FVIZ_API FVizResult fviz_unstructured_grid_geometry_filter_update(
    FVizUnstructuredGridGeometryFilter* filter);
