...
FVIZ_API FVizResult fviz_field_extract_component(
    const FVizDataArray* source, uint32_t component, FVizDataArray** out_values);
FVIZ_API FVizResult fviz_field_compute_magnitude(
    const FVizDataArray* source, FVizDataArray** out_values);
FVIZ_API FVizResult fviz_field_compute_finite_mask(
...
FVIZ_API FVizResult fviz_field_gather_by_ids(
...
FVIZ_API FVizResult fviz_field_indexed_weighted_average(
    const FVizDataArray* source_values,
...
FVIZ_API FVizResult fviz_field_apply_tuple_matrix(
    const FVizDataArray* source_values,
    const double* matrix,
...
FVIZ_API FVizResult fviz_field_least_squares_operator(
...
FVIZ_API FVizResult fviz_field_compute_indexed_discontinuity_mask(
    const FVizDataArray* source_values,
    const FVizDataArray* destination_indices,
    FVizSize destination_tuple_count,
