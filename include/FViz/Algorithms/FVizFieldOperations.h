...
FVIZ_API void fviz_field_gather_options_initialize(FVizFieldGatherOptions* options);
FVIZ_API void fviz_indexed_average_options_initialize(FVizIndexedAverageOptions* options);
FVIZ_API FVizResult fviz_field_extract_component(const FVizDataArray* source, uint32_t component,
                                                 FVizDataArray** out_values);
FVIZ_API FVizResult fviz_field_compute_magnitude(const FVizDataArray* source, FVizDataArray** out_values);
FVIZ_API FVizResult fviz_field_compute_finite_mask(const FVizDataArray* source, FVizDataArray** out_mask);
...
FVIZ_API FVizResult fviz_field_gather_by_ids(const FVizDataArray* source_values, const FVizDataArray* source_ids,
...
FVIZ_API FVizResult fviz_field_indexed_weighted_average(const FVizDataArray* source_values,
...
FVIZ_API FVizResult fviz_field_apply_tuple_matrix(const FVizDataArray* source_values, const double* matrix,
...
FVIZ_API FVizResult fviz_field_least_squares_operator(const double* basis_matrix, FVizSize sample_count,
...
FVIZ_API FVizResult fviz_field_compute_indexed_discontinuity_mask(const FVizDataArray* source_values,
                                                                  const FVizDataArray* destination_indices,
                                                                  FVizSize destination_tuple_count,
