...
FVIZ_FILTERS_API void fviz_deformation_metrics_initialize(FVizDeformationMetrics* metrics);
...
FVIZ_FILTERS_API FVizResult fviz_deformation_measure_vectors(const FVizDataArray* vectors, FVizDeformationMetrics* out_metrics);
...
FVIZ_FILTERS_API FVizResult fviz_deformation_compute_auto_scale(FVizBounds model_bounds, const FVizDataArray* vectors,
                                                        double target_fraction, double minimum_scale,
                                                        double maximum_scale, double* out_scale,
...
FVIZ_FILTERS_API FVizResult fviz_deformation_apply_to_points(const FVizPoints* points, const FVizDataArray* vectors,
                                                     double scale, FVizPoints** out_points);
FVIZ_FILTERS_API FVizResult fviz_deformation_apply_to_poly_data(const FVizPolyData* poly_data, const FVizDataArray* vectors,
                                                        double scale, FVizPolyData** out_poly_data);
FVIZ_FILTERS_API FVizResult fviz_deformation_apply_to_unstructured_grid(const FVizUnstructuredGrid* grid,
...
FVIZ_FILTERS_API FVizResult fviz_deformation_update_points(FVizPoints* destination, const FVizPoints* base_points,
                                                   const FVizDataArray* vectors, double scale);
FVIZ_FILTERS_API FVizResult fviz_deformation_update_poly_data_points(FVizPolyData* destination,
                                                             const FVizPolyData* base_poly_data,
                                                             const FVizDataArray* vectors, double scale);
FVIZ_FILTERS_API FVizResult fviz_deformation_update_unstructured_grid_points(FVizUnstructuredGrid* destination,
