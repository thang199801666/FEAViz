...
FVIZ_API FVizResult fviz_smooth_poly_data_filter_create(FVizSmoothPolyDataFilter** out_filter);
FVIZ_API FVizResult fviz_smooth_poly_data_filter_set_iterations(FVizSmoothPolyDataFilter* filter, uint32_t iterations);
FVIZ_API uint32_t fviz_smooth_poly_data_filter_iterations(const FVizSmoothPolyDataFilter* filter);
FVIZ_API FVizResult fviz_smooth_poly_data_filter_set_relaxation_factor(FVizSmoothPolyDataFilter* filter, double factor);
FVIZ_API double fviz_smooth_poly_data_filter_relaxation_factor(const FVizSmoothPolyDataFilter* filter);
...
FVIZ_API FVizResult fviz_smooth_poly_data_filter_update(FVizSmoothPolyDataFilter* filter);
...
FVIZ_API FVizResult fviz_decimate_poly_data_filter_update(FVizDecimatePolyDataFilter* filter);
...
FVIZ_API FVizResult fviz_clip_poly_data_filter_create(FVizClipPolyDataFilter** out_filter);
FVIZ_API void fviz_clip_poly_data_filter_set_plane(FVizClipPolyDataFilter* filter, FVizPlane plane);
FVIZ_API FVizPlane fviz_clip_poly_data_filter_plane(const FVizClipPolyDataFilter* filter);
FVIZ_API void fviz_clip_poly_data_filter_set_inside_out(FVizClipPolyDataFilter* filter, FVizBool inside_out);
FVIZ_API FVizBool fviz_clip_poly_data_filter_inside_out(const FVizClipPolyDataFilter* filter);
...
FVIZ_API FVizResult fviz_clip_poly_data_filter_update(FVizClipPolyDataFilter* filter);
