...
FVIZ_API FVizResult fviz_image_data_geometry_filter_set_input_data(FVizImageDataGeometryFilter* filter,
                                                                   FVizImageData* input);
FVIZ_API FVizResult fviz_image_data_geometry_filter_set_input_connection(FVizImageDataGeometryFilter* filter,
