...
typedef void* (*FVizReallocateFn)(
    void* user_data,
    void* memory,
    FVizSize old_size,
    FVizSize new_size,
    FVizSize alignment);
typedef void (*FVizDeallocateFn)(
    void* user_data,
    void* memory,
    FVizSize size,
    FVizSize alignment);
...
FVIZ_API void* fviz_allocator_allocate(
    const FVizAllocator* allocator,
    FVizSize size,
    FVizSize alignment);
FVIZ_API void* fviz_allocator_reallocate(
    const FVizAllocator* allocator,
    void* memory,
    FVizSize old_size,
    FVizSize new_size,
    FVizSize alignment);
FVIZ_API void fviz_allocator_deallocate(
    const FVizAllocator* allocator,
    void* memory,
    FVizSize size,
    FVizSize alignment);
