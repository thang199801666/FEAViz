...
FVIZ_DATA_API FVizResult fviz_bvh_create(FVizBVH** out_bvh);
FVIZ_DATA_API FVizResult fviz_bvh_build(FVizBVH* bvh, const FVizPolyData* poly_data);
...
FVIZ_DATA_API FVizResult fviz_bvh_refit(FVizBVH* bvh);
...
FVIZ_DATA_API FVizResult fviz_bvh_update(FVizBVH* bvh);
FVIZ_DATA_API FVizBool fviz_bvh_valid(const FVizBVH* bvh);
FVIZ_DATA_API FVizBool fviz_bvh_current(const FVizBVH* bvh);
FVIZ_DATA_API FVizBool fviz_bvh_refit_required(const FVizBVH* bvh);
FVIZ_DATA_API FVizSize fviz_bvh_triangle_count(const FVizBVH* bvh);
FVIZ_DATA_API FVizBool fviz_bvh_ray_cast(const FVizBVH* bvh, FVizRay ray, FVizRayHit* out_hit);
FVIZ_DATA_API FVizBool fviz_bvh_ray_cast_any(const FVizBVH* bvh, FVizRay ray);
...
FVIZ_DATA_API FVizResult fviz_bvh_closest_point(const FVizBVH* bvh, FVizVec3 query, float max_distance,
...
FVIZ_DATA_API FVizResult fviz_bvh_ray_cast_batch(const FVizBVH* bvh, const FVizRay* rays, FVizSize query_count,
                                            FVizRayHit* out_hits, FVizBool* out_hit_flags,
                                            FVizCancellationToken* cancellation);
FVIZ_DATA_API FVizResult fviz_bvh_closest_point_batch(const FVizBVH* bvh, const FVizVec3* queries, FVizSize query_count,
...
FVIZ_DATA_API FVizSize fviz_bvh_memory_size(const FVizBVH* bvh);
...
FVIZ_DATA_API FVizBool fviz_bvh_intersects_bounds(const FVizBVH* bvh, const FVizBounds* bounds);
