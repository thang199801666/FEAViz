...
FVIZ_API FVizResult fviz_symmetric_tensor3d_from_components(const double* components, uint32_t component_count,
...
FVIZ_API FVizResult fviz_symmetric_tensor3d_deviatoric(const FVizSymmetricTensor3d* tensor,
                                                       FVizSymmetricTensor3d* out_tensor);
...
FVIZ_API FVizResult fviz_symmetric_tensor3d_eigensystem(const FVizSymmetricTensor3d* tensor, double out_values[3],
