...
FVIZ_CORE_API FVizResult fviz_symmetric_tensor3d_from_components(const double* components, uint32_t component_count,
                                                            FVizSymmetricTensor3d* out_tensor);
FVIZ_CORE_API double fviz_symmetric_tensor3d_trace(const FVizSymmetricTensor3d* tensor);
FVIZ_CORE_API double fviz_symmetric_tensor3d_mean(const FVizSymmetricTensor3d* tensor);
FVIZ_CORE_API FVizResult fviz_symmetric_tensor3d_deviatoric(const FVizSymmetricTensor3d* tensor,
                                                       FVizSymmetricTensor3d* out_tensor);
...
FVIZ_CORE_API FVizResult fviz_symmetric_tensor3d_eigensystem(const FVizSymmetricTensor3d* tensor, double out_values[3],
