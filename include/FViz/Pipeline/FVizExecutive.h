...
FVIZ_API FVizResult fviz_pipeline_request_set_piece(FVizPipelineRequestInfo* request, uint32_t piece,
                                                    uint32_t number_of_pieces, uint32_t ghost_levels);
FVIZ_API FVizResult fviz_pipeline_request_set_extent(FVizPipelineRequestInfo* request, const int64_t extent[6]);
...
FVIZ_API FVizResult fviz_executive_update_request(FVizExecutive* executive, const FVizPipelineRequestInfo* request);
...
FVIZ_API FVizResult fviz_executive_update_piece(FVizExecutive* executive, uint32_t output_port, uint32_t piece,
                                                uint32_t number_of_pieces, uint32_t ghost_levels);
FVIZ_API FVizResult fviz_executive_update_extent(FVizExecutive* executive, uint32_t output_port,
                                                 const int64_t extent[6], uint32_t ghost_levels);
FVIZ_API FVizResult fviz_executive_update_time(FVizExecutive* executive, uint32_t output_port, double time);
...
FVIZ_API FVizResult fviz_executive_write_dot(const FVizExecutive* executive, char* text, FVizSize capacity,
