...
typedef FVizResult (*FVizAlgorithmMapInputRequestFn)(
    FVizAlgorithm* algorithm,
    uint32_t input_port,
    uint32_t connection,
...
#define FVIZ_ALGORITHM_CALLBACKS_V1_SIZE \
    ((uint32_t)offsetof(FVizAlgorithmCallbacks, state_object))
#define FVIZ_ALGORITHM_CALLBACKS_V2_SIZE \
    ((uint32_t)offsetof(FVizAlgorithmCallbacks, map_input_request))
...
FVIZ_API FVizResult fviz_algorithm_update_async(
...
FVIZ_API FVizResult fviz_algorithm_update_async_chain(
    FVizAlgorithm** algorithms, FVizSize count,
    FVizExecutor* executor, int priority,
    FVizFuture** out_future);
...
FVIZ_API FVizResult fviz_algorithm_set_output_time_steps(
    FVizAlgorithm* algorithm,
    uint32_t port,
    const double* time_steps,
    FVizSize count);
FVIZ_API const double* fviz_algorithm_output_time_steps(
    const FVizAlgorithm* algorithm,
    uint32_t port,
    FVizSize* out_count);
FVIZ_API FVizResult fviz_algorithm_output_time_range(
    const FVizAlgorithm* algorithm,
    uint32_t port,
    double* out_minimum,
    double* out_maximum);
...
FVIZ_API FVizResult fviz_algorithm_set_output_whole_extent(
...
FVIZ_API FVizBool fviz_algorithm_output_whole_extent(
