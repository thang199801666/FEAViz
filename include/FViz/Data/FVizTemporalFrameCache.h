...
typedef FVizResult (*FVizTemporalFrameLoaderFn)(
    FVizId frame_key,
...
FVIZ_API void fviz_temporal_frame_cache_options_initialize(
    FVizTemporalFrameCacheOptions* options);
FVIZ_API FVizResult fviz_temporal_frame_cache_create(
    FVizTemporalFrameLoaderFn loader,
    void* user_data,
    FVizTemporalFrameCache** out_cache);
FVIZ_API FVizResult fviz_temporal_frame_cache_set_options(
    FVizTemporalFrameCache* cache,
    const FVizTemporalFrameCacheOptions* options);
FVIZ_API void fviz_temporal_frame_cache_get_options(
...
FVIZ_API FVizResult fviz_temporal_frame_cache_get(
    FVizTemporalFrameCache* cache,
    FVizId frame_key,
    FVizCancellationToken* cancellation,
    FVizDataObject** out_frame);
FVIZ_API FVizResult fviz_temporal_frame_cache_prefetch(
    FVizTemporalFrameCache* cache,
...
FVIZ_API FVizResult fviz_temporal_frame_cache_request_async(
    FVizTemporalFrameCache* cache,
    FVizId frame_key,
    FVizTemporalFrameFuture** out_future);
FVIZ_API void fviz_temporal_frame_future_cancel(FVizTemporalFrameFuture* future);
FVIZ_API FVizBool fviz_temporal_frame_future_ready(
    const FVizTemporalFrameFuture* future);
/* Waits and returns a retained frame on success. Repeated waits are allowed. */
FVIZ_API FVizResult fviz_temporal_frame_future_wait(
...
FVIZ_API FVizResult fviz_temporal_prefetch_queue_create(
    FVizTemporalFrameCache* cache,
...
FVIZ_API FVizResult fviz_temporal_prefetch_queue_request(
...
FVIZ_API FVizResult fviz_temporal_prefetch_queue_request_window(
    FVizTemporalPrefetchQueue* queue,
    FVizId current_key,
    int direction,
    FVizSize ahead_count,
    FVizSize behind_count);
FVIZ_API FVizResult fviz_temporal_prefetch_queue_wait_idle(
    FVizTemporalPrefetchQueue* queue);
FVIZ_API FVizSize fviz_temporal_prefetch_queue_pending_count(
    const FVizTemporalPrefetchQueue* queue);
FVIZ_API void fviz_temporal_prefetch_queue_destroy(FVizTemporalPrefetchQueue* queue);
FVIZ_API FVizResult fviz_temporal_frame_cache_invalidate(
    FVizTemporalFrameCache* cache,
    FVizId frame_key);
FVIZ_API void fviz_temporal_frame_cache_clear(FVizTemporalFrameCache* cache);
FVIZ_API void fviz_temporal_frame_cache_get_statistics(
    const FVizTemporalFrameCache* cache,
