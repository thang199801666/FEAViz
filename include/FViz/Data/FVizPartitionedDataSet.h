...
FVIZ_API FVizResult fviz_partitioned_data_set_reserve(
...
FVIZ_API FVizResult fviz_partitioned_data_set_add_partition(
    FVizPartitionedDataSet* data_set,
    FVizDataObject* partition,
    const char* name,
    FVizSize* out_index);
FVIZ_API FVizResult fviz_partitioned_data_set_set_partition(
    FVizPartitionedDataSet* data_set,
    FVizSize index,
    FVizDataObject* partition);
FVIZ_API FVizDataObject* fviz_partitioned_data_set_partition(
    FVizPartitionedDataSet* data_set,
    FVizSize index);
FVIZ_API const FVizDataObject* fviz_partitioned_data_set_const_partition(
    const FVizPartitionedDataSet* data_set,
    FVizSize index);
FVIZ_API FVizResult fviz_partitioned_data_set_set_partition_name(
    FVizPartitionedDataSet* data_set,
    FVizSize index,
    const char* name);
FVIZ_API const char* fviz_partitioned_data_set_partition_name(
    const FVizPartitionedDataSet* data_set,
    FVizSize index);
FVIZ_API FVizResult fviz_partitioned_data_set_remove_partition(
    FVizPartitionedDataSet* data_set,
    FVizSize index);
