...
FVIZ_API FVizResult fviz_temporal_data_set_add_step(
    FVizTemporalDataSet* data_set,
    double time,
    FVizDataObject* data,
    FVizSize* out_index);
FVIZ_API FVizResult fviz_temporal_data_set_set_step(
    FVizTemporalDataSet* data_set,
    FVizSize index,
    double time,
    FVizDataObject* data);
...
FVIZ_API FVizResult fviz_temporal_data_set_append_steps(
    FVizTemporalDataSet* data_set,
    const double* times,
...
FVIZ_API FVizResult fviz_temporal_data_set_time_range(
    const FVizTemporalDataSet* data_set,
    double* out_minimum,
    double* out_maximum);
FVIZ_API FVizResult fviz_temporal_data_set_find_nearest(
    const FVizTemporalDataSet* data_set,
    double time,
    FVizSize* out_index);
...
FVIZ_API FVizResult fviz_temporal_data_set_find_bracket(
    const FVizTemporalDataSet* data_set,
    double time,
