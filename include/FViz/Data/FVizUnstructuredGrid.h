...
FVIZ_API FVizResult fviz_unstructured_grid_shallow_copy(
...
FVIZ_API FVizResult fviz_unstructured_grid_reserve(
...
FVIZ_API FVizResult fviz_unstructured_grid_add_points(
    FVizUnstructuredGrid* grid, const FVizVec3* points, FVizSize point_count, uint32_t* out_first_id);
FVIZ_API FVizResult fviz_unstructured_grid_add_points_ids(
...
FVIZ_API FVizResult fviz_unstructured_grid_extract_geometry(
    const FVizUnstructuredGrid* grid,
...
FVIZ_API FVizResult fviz_unstructured_grid_warp_by_vector(
    ...
    double scale,
    FVizUnstructuredGrid** out_grid);
FVIZ_API FVizResult fviz_unstructured_grid_warp_by_array(
    const FVizUnstructuredGrid* grid,
