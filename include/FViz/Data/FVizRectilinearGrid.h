...
FVIZ_API FVizResult fviz_rectilinear_grid_set_extent(FVizRectilinearGrid* grid, const int64_t extent[6]);
FVIZ_API void fviz_rectilinear_grid_extent(const FVizRectilinearGrid* grid, int64_t out_extent[6]);
FVIZ_API void fviz_rectilinear_grid_dimensions(const FVizRectilinearGrid* grid, FVizSize out_dimensions[3]);
...
FVIZ_API FVizResult fviz_rectilinear_grid_set_coordinates(FVizRectilinearGrid* grid, uint32_t axis,
                                                          FVizDataArray* coordinates);
FVIZ_API FVizResult fviz_rectilinear_grid_set_coordinate_values(FVizRectilinearGrid* grid, uint32_t axis,
...
FVIZ_API const FVizDataArray* fviz_rectilinear_grid_const_coordinates(const FVizRectilinearGrid* grid, uint32_t axis);
FVIZ_API FVizResult fviz_rectilinear_grid_point(const FVizRectilinearGrid* grid, FVizId point_id, FVizVec3* out_point);
FVIZ_API FVizBounds fviz_rectilinear_grid_bounds(const FVizRectilinearGrid* grid);

FVIZ_API FVizResult fviz_rectilinear_grid_point_id(const FVizRectilinearGrid* grid, int64_t i, int64_t j, int64_t k,
                                                   FVizId* out_point_id);
FVIZ_API FVizResult fviz_rectilinear_grid_point_ijk(const FVizRectilinearGrid* grid, FVizId point_id,
                                                    int64_t out_ijk[3]);
FVIZ_API FVizResult fviz_rectilinear_grid_cell_id(const FVizRectilinearGrid* grid, int64_t i, int64_t j, int64_t k,
                                                  FVizId* out_cell_id);
FVIZ_API FVizResult fviz_rectilinear_grid_cell_ijk(const FVizRectilinearGrid* grid, FVizId cell_id, int64_t out_ijk[3]);
FVIZ_API FVizResult fviz_rectilinear_grid_cell_point_ids(const FVizRectilinearGrid* grid, FVizId cell_id,
