...
FVIZ_API FVizResult fviz_provenance_create_identity(FVizSize tuple_count, FVizDataArray** out_ids);
FVIZ_API FVizResult fviz_provenance_validate(const FVizDataArray* ids, FVizSize expected_tuple_count);
...
FVIZ_API FVizResult fviz_provenance_resolve(const FVizAttributeSet* attributes, FVizProvenanceEntity entity,
                                            FVizSize local_id, FVizId fallback, FVizId* out_source_id,
                                            FVizBool* out_persistent);
FVIZ_API FVizResult fviz_provenance_find(const FVizAttributeSet* attributes, FVizProvenanceEntity entity,
...
FVIZ_API FVizResult fviz_provenance_compose(const FVizDataArray* upstream_ids, const FVizDataArray* local_to_upstream,
