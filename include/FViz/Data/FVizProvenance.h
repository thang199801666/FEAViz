...
FVIZ_DATA_API const char* fviz_provenance_array_name(FVizProvenanceEntity entity);
FVIZ_DATA_API FVizResult fviz_provenance_create_identity(FVizSize tuple_count, FVizDataArray** out_ids);
FVIZ_DATA_API FVizResult fviz_provenance_validate(const FVizDataArray* ids, FVizSize expected_tuple_count);
...
FVIZ_DATA_API FVizResult fviz_provenance_resolve(const FVizAttributeSet* attributes, FVizProvenanceEntity entity,
                                            FVizSize local_id, FVizId fallback, FVizId* out_source_id,
                                            FVizBool* out_persistent);
FVIZ_DATA_API FVizResult fviz_provenance_find(const FVizAttributeSet* attributes, FVizProvenanceEntity entity,
                                         FVizId source_id, FVizSize* out_local_id);
...
FVIZ_DATA_API FVizResult fviz_provenance_compose(const FVizDataArray* upstream_ids, const FVizDataArray* local_to_upstream,
