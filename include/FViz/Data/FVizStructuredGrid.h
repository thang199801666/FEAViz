...
FVIZ_API FVizResult fviz_structured_grid_create(FVizStructuredGrid** out_grid);
FVIZ_API void fviz_structured_grid_clear(FVizStructuredGrid* grid);
...
FVIZ_API FVizResult fviz_structured_grid_set_extent(FVizStructuredGrid* grid, const int64_t extent[6]);
FVIZ_API void fviz_structured_grid_extent(const FVizStructuredGrid* grid, int64_t out_extent[6]);
FVIZ_API void fviz_structured_grid_dimensions(const FVizStructuredGrid* grid, FVizSize out_dimensions[3]);
FVIZ_API uint32_t fviz_structured_grid_dimension(const FVizStructuredGrid* grid);
FVIZ_API FVizSize fviz_structured_grid_point_count(const FVizStructuredGrid* grid);
...
FVIZ_API FVizAttributeSet* fviz_structured_grid_field_data(FVizStructuredGrid* grid);
FVIZ_API const FVizAttributeSet* fviz_structured_grid_const_point_data(const FVizStructuredGrid* grid);
FVIZ_API const FVizAttributeSet* fviz_structured_grid_const_cell_data(const FVizStructuredGrid* grid);
FVIZ_API const FVizAttributeSet* fviz_structured_grid_const_field_data(const FVizStructuredGrid* grid);
FVIZ_API FVizResult fviz_structured_grid_validate(const FVizStructuredGrid* grid);
