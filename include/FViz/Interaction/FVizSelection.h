...
FVIZ_API FVizBool fviz_selection_contains(
    const FVizSelection* selection,
    const FVizActor* actor,
    FVizSelectionAssociation association,
    FVizSize id);
FVIZ_API FVizResult fviz_selection_remove(
    FVizSelection* selection,
    const FVizActor* actor,
    FVizSelectionAssociation association,
    FVizSize id);
FVIZ_API FVizResult fviz_selection_copy(
    const FVizSelection* source,
    FVizSelection** out_selection);
FVIZ_API FVizResult fviz_selection_apply(
    FVizSelection* selection,
...
FVIZ_API FVizResult fviz_selection_select_frustum(
    FVizRenderer* renderer,
    const FVizFrustum* frustum,
    FVizSelectionAssociation association,
    FVizSelection** out_selection);
FVIZ_API FVizResult fviz_selection_select_polygon(
    FVizRenderer* renderer,
    int display_width,
    int display_height,
    const int* xy_points,
...
FVIZ_API FVizResult fviz_selection_select_polygon_with_options(
    ...
    FVizSelection** out_selection);
FVIZ_API FVizResult fviz_selection_select_rectangle(
    FVizRenderer* renderer,
    int display_width,
    int display_height,
    int start_x,
...
FVIZ_API FVizResult fviz_selection_create_mask(
    const FVizSelection* selection,
    const FVizActor* actor,
    FVizSelectionAssociation association,
...
FVIZ_API FVizResult fviz_selection_convert_association(
    const FVizSelection* selection,
    FVizActor* actor,
...
FVIZ_API FVizResult fviz_selection_extract_poly_data(
    const FVizSelection* selection,
    const FVizActor* actor,
    FVizSelectionAssociation association,
    FVizPolyData** out_poly_data);

FVIZ_API FVizResult fviz_named_selection_collection_create(
    FVizNamedSelectionCollection** out_collection);
/* Adds or atomically replaces a named retained selection. */
FVIZ_API FVizResult fviz_named_selection_collection_set(
    FVizNamedSelectionCollection* collection,
    const char* name,
    FVizSelection* selection);
FVIZ_API FVizResult fviz_named_selection_collection_remove(
    FVizNamedSelectionCollection* collection, const char* name);
FVIZ_API void fviz_named_selection_collection_clear(
    FVizNamedSelectionCollection* collection);
FVIZ_API FVizSize fviz_named_selection_collection_count(
    const FVizNamedSelectionCollection* collection);
FVIZ_API const char* fviz_named_selection_collection_name(
...
FVIZ_API FVizSelection* fviz_named_selection_collection_get(
    FVizNamedSelectionCollection* collection, const char* name);
