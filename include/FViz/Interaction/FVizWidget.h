...
typedef FVizBool (*FVizWidgetEventHandlerFn)(
    FVizWidget* widget,
    const FVizInteractionEvent* event,
    void* user_data);

typedef void (*FVizWidgetCallbackFn)(
    FVizWidget* widget,
    FVizWidgetNotification notification,
    void* user_data);

FVIZ_API FVizResult fviz_widget_create(
...
FVIZ_API FVizResult fviz_widget_set_representation(
...
FVIZ_API void fviz_widget_set_event_handler(
    FVizWidget* widget, FVizWidgetEventHandlerFn handler, void* user_data);
FVIZ_API void fviz_widget_set_callback(
    FVizWidget* widget, FVizWidgetCallbackFn callback, void* user_data);
FVIZ_API FVizBool fviz_widget_process_event(
    FVizWidget* widget, const FVizInteractionEvent* event);
