...
FVIZ_API FVizResult fviz_handle_widget_create(FVizRenderWindowInteractor* interactor, FVizRenderer* renderer,
...
FVIZ_API void fviz_handle_widget_set_color(FVizHandleWidget* widget, float red, float green, float blue);
FVIZ_API void fviz_handle_widget_set_manipulator_mode(FVizHandleWidget* widget, FVizWidgetManipulatorMode mode);
FVIZ_API FVizWidgetManipulatorMode fviz_handle_widget_manipulator_mode(const FVizHandleWidget* widget);
...
FVIZ_API FVizResult fviz_plane_widget_create(FVizRenderWindowInteractor* interactor, FVizRenderer* renderer,
...
FVIZ_API FVizResult fviz_box_widget_create(FVizRenderWindowInteractor* interactor, FVizRenderer* renderer,
...
FVIZ_API FVizResult fviz_line_widget_create(FVizRenderWindowInteractor* interactor, FVizRenderer* renderer,
                                            FVizLineWidget** out_widget);
FVIZ_API FVizWidget* fviz_line_widget_widget(FVizLineWidget* widget);
FVIZ_API void fviz_line_widget_set_points(FVizLineWidget* widget, FVizVec3 point1, FVizVec3 point2);
FVIZ_API void fviz_line_widget_get_points(const FVizLineWidget* widget, FVizVec3* point1, FVizVec3* point2);
FVIZ_API float fviz_line_widget_length(const FVizLineWidget* widget);
FVIZ_API void fviz_line_widget_set_color(FVizLineWidget* widget, float red, float green, float blue);
...
FVIZ_API FVizResult fviz_distance_widget_create(FVizRenderWindowInteractor* interactor, FVizRenderer* renderer,
...
FVIZ_API FVizResult fviz_angle_widget_create(FVizRenderWindowInteractor* interactor, FVizRenderer* renderer,
                                             FVizAngleWidget** out_widget);
FVIZ_API FVizWidget* fviz_angle_widget_widget(FVizAngleWidget* widget);
FVIZ_API FVizResult fviz_angle_widget_set_points(FVizAngleWidget* widget, FVizVec3 point1, FVizVec3 vertex,
                                                 FVizVec3 point2);
...
FVIZ_API FVizResult fviz_section_cut_widget_create(FVizRenderWindowInteractor* interactor, FVizRenderer* renderer,
...
FVIZ_API FVizResult fviz_probe_widget_create(FVizRenderWindowInteractor* interactor, FVizRenderer* renderer,
