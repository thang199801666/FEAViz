...
typedef FVizResult (*FVizTaskContextFn)(
    FVizTaskContext* context, void* user_data, void** out_value);
typedef FVizResult (*FVizContinuationFn)(
    FVizResult antecedent_result,
    FVizCancellationToken* cancellation,
    void* user_data,
    void** out_value);
typedef void (*FVizFutureProgressFn)(
    FVizFuture* future, double progress, void* user_data);
...
FVIZ_API FVizResult fviz_executor_create(
...
FVIZ_API FVizResult fviz_executor_submit(
...
FVIZ_API FVizResult fviz_executor_submit_context(
    FVizExecutor* executor,
    int priority,
    FVizTaskContextFn function,
    void* user_data,
    FVizTaskDataDestroyFn user_data_destroy,
    FVizTaskValueDestroyFn value_destroy,
    FVizFuture** out_future);
...
FVIZ_API FVizResult fviz_future_then(
    FVizFuture* antecedent,
    FVizExecutor* executor,
    int priority,
    FVizContinuationFn function,
    void* user_data,
    FVizTaskDataDestroyFn user_data_destroy,
    FVizTaskValueDestroyFn value_destroy,
    FVizFuture** out_future);
FVIZ_API void fviz_executor_get_statistics(
...
FVIZ_API FVizResult fviz_task_context_report_progress(
    FVizTaskContext* context, double progress);
FVIZ_API double fviz_future_progress(const FVizFuture* future);
FVIZ_API void fviz_future_set_progress_callback(
