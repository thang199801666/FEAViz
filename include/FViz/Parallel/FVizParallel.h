...
FVIZ_API FVizResult fviz_parallel_context_create(
...
FVIZ_API void fviz_parallel_context_get_statistics(
...
FVIZ_API FVizResult fviz_parallel_context_for(
...
FVIZ_API FVizResult fviz_task_group_create(
    FVizParallelContext* context,
    FVizCancellationToken* cancellation,
...
FVIZ_API FVizResult fviz_parallel_sum_f64(
    FVizParallelContext* context,
    const double* values,
    FVizSize count,
    double* out_sum,
...
FVIZ_API FVizResult fviz_parallel_exclusive_scan_u64(
    ...
    uint64_t* out_total);
FVIZ_API FVizResult fviz_parallel_inclusive_scan_u64(
    FVizParallelContext* context,
    const uint64_t* input,
    uint64_t* output,
    FVizSize count,
    uint64_t* out_total);
FVIZ_API FVizResult fviz_parallel_stable_sort_u64_indices(
    FVizParallelContext* context,
    const uint64_t* keys,
    FVizSize* indices,
    FVizSize count);
